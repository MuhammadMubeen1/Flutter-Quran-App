...
String getSurahData(int surahNumber) {
  return '${getPlaceMakiMadni(surahNumber)}- ${getNumberOfAyahs(surahNumber)} Verses ';
...
String getPlaceMakiMadni(int surahNumber) {
  return surah[surahNumber - 1]['revelation_place'] as String;
}
